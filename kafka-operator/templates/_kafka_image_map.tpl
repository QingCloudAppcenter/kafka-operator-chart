...
{{- define "strimzi.kafka.image.map" }}
            ...
            - name: STRIMZI_KAFKA_IMAGES
              value: |
                3.2.0={{ template "strimzi.image" (merge . (dict "key" "kafka" "tagSuffix" "-kafka-3.2.0")) }}
            ...
            - name: STRIMZI_KAFKA_CONNECT_IMAGES
              value: |
                3.2.0={{ template "strimzi.image" (merge . (dict "key" "kafkaConnect" "tagSuffix" "-kafka-3.2.0")) }}
            ...
            - name: STRIMZI_KAFKA_MIRROR_MAKER_IMAGES
              value: |
                3.2.0={{ template "strimzi.image" (merge . (dict "key" "kafkaMirrorMaker" "tagSuffix" "-kafka-3.2.0")) }}
            ...
            - name: STRIMZI_KAFKA_MIRROR_MAKER_2_IMAGES
              value: |
                3.2.0={{ template "strimzi.image" (merge . (dict "key" "kafkaMirrorMaker2" "tagSuffix" "-kafka-3.2.0")) }}
